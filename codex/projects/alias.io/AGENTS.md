...
- If editing this `AGENTS.md`, make the canonical change in `/Users/elbert/Projects/dotfiles/codex/projects/alias.io/AGENTS.md`; the repository-root file is a symlink.
