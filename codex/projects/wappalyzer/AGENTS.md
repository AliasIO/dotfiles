...
- In `v4/apis-shared/shared.js`, preload `geoip-lite` during lookup Lambda init instead of first request-time fallback; cold-loading the GeoIP database inside `getGeoIp()` can consume most of the 30-second lookup budget before DNS even starts.
