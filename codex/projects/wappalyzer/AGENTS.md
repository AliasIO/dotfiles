...
- In `v4/apis/lookup/lookup.js`, run a short HTTP probe around live non-recursive browser analysis so redirected deny pages can be short-circuited or normalized into handled block errors instead of generic browser-session failures.
