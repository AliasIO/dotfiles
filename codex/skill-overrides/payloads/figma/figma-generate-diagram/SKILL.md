...
description: "Generate supported diagrams in Figma/FigJam through generate_diagram. Load before that tool call for renderer-specific constraints; route unsupported diagram types to an appropriate alternative."
---
