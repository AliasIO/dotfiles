...
description: "Recommend Stripe Connect account configuration and charge patterns for a platform or marketplace. Ask only for material unresolved business choices; preserve decisions and authority already provided."
---
...
**Resolve material decisions.** Infer choices supported by the user’s business description and prior answers. Ask concise questions only when liability, account configuration, money movement or another consequential choice remains unresolved. Honor authorization and decisions already provided.
...
End with the recommendation or completed result. Ask a further question only when necessary to resolve a material decision or continue requested work.
