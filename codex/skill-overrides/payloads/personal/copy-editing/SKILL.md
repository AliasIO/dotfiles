---
name: copy-editing
description: "Edit or review existing public-facing marketing copy while preserving its meaning and voice. Use copywriting for substantial new drafting. Do not trigger for code edits, internal notes or ordinary assistant prose."
metadata:
  version: 2.0.0
---
...
## Optional perspective review

For substantial copy, an optional pass from relevant reader or specialist perspectives can expose a specific remaining concern. It is a reasoning aid, not a simulated approval panel or proof of customer response.

### How It Works

Select perspectives relevant to the unresolved concern, such as a reader checking clarity or an editor checking evidence. Record the specific passage, issue, and proposed correction. Make one focused revision pass and continue only if a remaining issue materially affects accuracy, clarity, or the requested outcome. Do not assign self-generated scores as a release gate.
...
- **Optional** for substantial launch copy, pricing pages and high-traffic landing pages when another perspective can resolve a concrete concern
