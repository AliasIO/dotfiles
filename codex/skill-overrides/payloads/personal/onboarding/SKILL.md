---
name: onboarding
description: "Improve post-signup activation, onboarding and time to value. Empty states or loading screens activate this skill only when the request concerns onboarding or activation; use signup for registration."
metadata:
  version: 2.0.0
---
