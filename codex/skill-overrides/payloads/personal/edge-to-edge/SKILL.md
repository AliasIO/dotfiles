...
- Inspect the current target SDK and Compose versions. Apply compatible edge-to-edge behavior within the requested scope. An SDK upgrade is a separate migration; do not increase the target SDK merely to satisfy this workflow.
