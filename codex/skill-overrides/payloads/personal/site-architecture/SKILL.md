...
description: "Plan website hierarchy, navigation, URL structure or internal linking. Scale the output to the requested change; use seo-audit for XML sitemaps and schema for structured data."
metadata:
  version: 2.0.0
---
...
Select only the outputs needed for the requested decision. A full restructure may use the entire set below; a small navigation or URL change may need a short explanation and URL table only. Do not duplicate a sitemap as both ASCII and Mermaid unless both help the reader.
