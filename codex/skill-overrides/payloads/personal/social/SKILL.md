---
name: social
description: "Draft or revise social posts, plan social content, or inspect listening and engagement evidence. Scheduling, publishing and replies require matching user authority. Use content-strategy for broader planning."
metadata:
  version: 2.1.0
---
...
These proportions are illustrative; choose the mix from audience response, product stage and available resources.
...
Use accessible captions where appropriate. Any watch-time improvement depends on the audience, platform and creative; measure it rather than assuming a fixed lift.
