---
name: copywriting
description: "Draft or substantially rewrite website and product marketing copy. Use for headlines, positioning, landing pages and calls to action; use copy-editing for focused edits to existing copy."
metadata:
  version: 2.0.1
---
