...
description: "Gather or analyze customer interviews, transcripts, reviews, surveys and community evidence. Use for customer needs, personas, sentiment and reasons for buying, converting or churning."
metadata:
  version: 2.0.0
---
...
Use the deliverable named or clearly implied by the request. Ask only when the choice materially changes the work; otherwise provide the smallest useful synthesis.
