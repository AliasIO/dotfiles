...
if version >= 700
	...
	hi matchparen     guifg=#ff9900 guibg=NONE    gui=bold ctermfg=3    ctermbg=16 cterm=NONE
endif
...
hi nontext          guifg=#777777 guibg=#000000 gui=NONE      ctermfg=15   ctermbg=16   cterm=NONE
...
hi pmenusel         guifg=#ff9900 guibg=#222222 gui=NONE      ctermfg=3    ctermbg=16   cterm=NONE
hi search           guifg=NONE    guibg=#111111 gui=NONE      ctermfg=NONE ctermbg=16   cterm=NONE
hi specialkey       guifg=#ffffff guibg=#111111 gui=NONE      ctermfg=15   ctermbg=16   cterm=NONE
...
hi tablinesel       guifg=#ff9900 guibg=#222222 gui=NONE      ctermfg=3    ctermbg=16   cterm=NONE
...
hi treedir          guifg=#ff9900 guibg=#000000 gui=NONE      ctermfg=7    ctermbg=16   cterm=NONE
...
hi warningmsg       guifg=#ff9900 guibg=#000000 gui=NONE      ctermfg=15   ctermbg=16   cterm=NONE
hi wildmenu         guifg=#ff9900 guibg=#222222 gui=NONE      ctermfg=15   ctermbg=16   cterm=NONE
...
hi mytaglisttitle    guifg=#ff9900 guibg=#000000 gui=NONE ctermfg=NONE ctermbg=15 cterm=NONE
...
"syntax highlighting
hi comment       guifg=#777777 gui=italic ctermfg=8  cterm=NONE
hi constant      guifg=#ffffff gui=NONE   ctermfg=15 cterm=NONE
hi function      guifg=#999999 gui=NONE   ctermfg=7  cterm=NONE
hi identifier    guifg=#ff9900 gui=NONE   ctermfg=3  cterm=NONE
hi keyword       guifg=#ffffff gui=NONE   ctermfg=15 cterm=NONE
hi number        guifg=#ffffff gui=NONE   ctermfg=15 cterm=NONE
hi preproc       guifg=#777777 gui=NONE   ctermfg=8  cterm=NONE
...
hi type          guifg=#ff9900 gui=NONE   ctermfg=7  cterm=NONE
